...
export const createSalesOrderSchema = z.object({
  customerId: objectId,
  sourceWarehouseId: objectId.optional(),
  ...
  orderDiscount: z.object({ type: z.enum(["percentage", "fixed"]).optional(), value: z.coerce.number().min(0).optional(), reason: z.string().optional() }).optional(),
