...
import WarehouseFormModal from "../../../client/features/warehouses/WarehouseFormModal.jsx";
import { useWarehouses, useDeleteWarehouse } from "../../../client/features/warehouses/useWarehouses.js";
  ...
  const columns = [
    {
      ...
      render: (r) => (
        <div className="flex items-center gap-2">
          {r.isDefault && (
            <Star size={14} className="fill-amber-500 text-amber-500" title="Default" />
          )}
        ...
        canManage && (
          <div className="flex gap-1">
            ...
            <button
              ...
              className="rounded p-1.5 text-gray-500 hover:bg-red-50 hover:text-red-600 disabled:cursor-not-allowed disabled:opacity-30"
              title={r.isDefault ? "Can't delete default" : "Delete"}
            >
              <Trash2 size={16} />
            </button>
          </div>
